...
Alternativa: um feat que aumente Carisma em +1 e ofereça utilidade relevante, caso a mesa queira maior personalização.

A prioridade é aproximar a CD das magias e os recursos de classe do máximo possível.
...
Ela pode assumir tamanho Grande temporariamente, ganhando benefícios físicos e de deslocamento. Para Aeloria, isso pode ser interpretado como sua herança gigante se tornando impossível de ignorar — sem mudar sua personalidade calma.

### Uso narrativo

Quando assume Large Form, não precisa “virar um monstro”. A imagem pode ser de uma figura ainda mais alta, com roupas e cabelos movidos por uma corrente de ar constante.
...
Controle de campo, Glamour, mobilidade de Cloud's Jaunt, Large Form e Carisma máximo.

### Fim da campanha

Conjuradora completa de alto nível, com forte controle, suporte, Magical Secrets e presença capaz de decidir cenas dentro e fora de combate.

## Regra para futuras escolhas

Ao subir de nível, pergunte:
